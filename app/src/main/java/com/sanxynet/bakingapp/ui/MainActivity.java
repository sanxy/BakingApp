...
import com.sanxynet.bakingapp.fragment.RecipeFragment;
...
import com.sanxynet.bakingapp.service.SyncUtils;
...
import static com.sanxynet.bakingapp.utils.Utility.RequestPermissionExtStorage;

public class MainActivity extends BaseActivity implements
        RetroCall.RestData, RecipeFragment.FragmentInteractionListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private void initializeMainJob() {
        if (PrefManager.isPref(mContext, R.string.pref_insert_data)) {
            ...
            showProgressBar();
            new RetroCall().loadData(this,mIdlingResource);

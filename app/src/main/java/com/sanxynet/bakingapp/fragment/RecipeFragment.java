...
import com.sanxynet.bakingapp.adapter.RecipeAdapter;
import com.sanxynet.bakingapp.db.BakingAppContract;
import com.sanxynet.bakingapp.utils.Utility;
import timber.log.Timber;

import static com.sanxynet.bakingapp.utils.Costants.RECIPE_LOADER_ID;
...
public class RecipeFragment extends Fragment implements RecipeAdapter.ListItemClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static class RecipeFragmentAsyncTask extends AsyncTaskLoader<Cursor> {
        ...
        public Cursor loadInBackground() {
            try {
                return getContext().getContentResolver().query(BakingAppContract.RecipeEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
